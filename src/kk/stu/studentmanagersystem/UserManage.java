...
import kk.stu.studentmanagersystem.pojo.LoginUser;
...
public class UserManage extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.stu_usermanagelayout);
		mySqlHelper = new SqlHelper(UserManage.this, "student_inf.db", null,
				1);
			...
			public void onClick(View arg0) {
				...
				for (LoginUser loginUser : loginUsers) {
					...
					if (loginUser.isChecked()) {
						Cursor cursor = db.rawQuery("delete from stu_user where username = '"
	...
	public void showUser(){
		...
		Cursor cursor = db.rawQuery("select * from stu_user", null);
	...
	BaseAdapter adapter = new BaseAdapter() {
		...
		public View getView(int arg0, View arg1, ViewGroup arg2) {
			...
			View view = LayoutInflater.from(UserManage.this).inflate(
					R.layout.stu_userlistitems, null);
