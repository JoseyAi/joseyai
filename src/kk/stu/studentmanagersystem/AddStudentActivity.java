...
public class AddStudentActivity extends Activity {
	...
	private EditText stu_yuanxiao;
	private EditText stu_xibie;
	private EditText stu_banji;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.stu_addstudentlayout);

		mySqlHelper = new SqlHelper(AddStudentActivity.this,
		...
		stu_yuanxiao = (EditText) findViewById(R.id.stu_yuanxiao);
		stu_xibie = (EditText) findViewById(R.id.stu_xibie);
		stu_banji = (EditText) findViewById(R.id.stu_banji);
	...
	public void addStudentInf() {
		...
		if (stu_name.getText().toString().equals("")
				...
				|| stu_yuanxiao.getText().toString().equals("")
				|| stu_xibie.getText().toString().equals("")
				|| stu_banji.getText().toString().equals("")) {
			...
			values.put("yuanxiao", stu_yuanxiao.getText().toString());
			values.put("xibie", stu_xibie.getText().toString());
			values.put("banji", stu_banji.getText().toString());
