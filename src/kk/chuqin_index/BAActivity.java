 ...
 * 
 */
public class BAActivity extends Activity implements View.OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.chuqin_calendar_main);
	...
	private void addGridView() {
		...
		gridView.setOnTouchListener(new OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				return BAActivity.this.gestureDetector.onTouchEvent(event);
			}
		});
		...
		gridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
				...
				if (startPosition <= position + 7 && position <= endPosition - 7) {
					...
					Toast.makeText(BAActivity.this, scheduleYear + "-" + scheduleMonth + "-" + scheduleDay, 2000).show();
